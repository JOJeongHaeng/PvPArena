...
BATCH_SETTINGS = {
    "/Game/PvPArena/Textures/Trim_Textures/T_Trim_Pipe_1_N": {"max_texture_size": 1024},
}
...
def main() -> None:
    ...
    unreal.log(f"texture_budget_batch_4 complete; changed {len(changed_assets)} assets")
